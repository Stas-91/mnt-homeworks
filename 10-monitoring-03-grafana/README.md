# Домашнее задание к занятию 14 «Средство визуализации Grafana» Станислав Помельников
...
- Утилизация CPU в процентах (100 - idle) - ```100 - (avg by (instance) (rate(node_cpu_seconds_total{mode="idle"}[5m])) * 100)```
- CPU Load Average (1 минута) - ```node_load1```
- CPU Load Average (5 минут) - ```node_load5```
